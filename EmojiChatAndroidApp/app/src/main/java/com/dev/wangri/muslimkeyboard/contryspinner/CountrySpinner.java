package com.dev.wangri.muslimkeyboard.contryspinner;
...
//        ArrayAdapter adapter = new ArrayAdapter<String>(getContext(), android.R.layout.simple_spinner_item, countryList);
        CountryNameAdapter adapter = new CountryNameAdapter(getContext(), countryList);
        ...
        setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                final String selectedCountry = countryList.get(position);
