...
//        multiCallback.addView(view);
        if (message.type == Message.MessageType.Text) {
            if (message.userID.equals(FirebaseManager.getInstance().getCurrentUserID())) {
                ...
                holder.textViewSender.setText(Util.getEmoticanText(context, message.message, multiCallback, false));
                if (Util.bIsOnlyEmoji(message.message)) {
...
//                holder.textViewReceiver.setText(message.message);
                holder.textViewReceiver.setText(Util.getEmoticanText(context, message.message, multiCallback, false));
                if (Util.bIsOnlyEmoji(message.message)) {
