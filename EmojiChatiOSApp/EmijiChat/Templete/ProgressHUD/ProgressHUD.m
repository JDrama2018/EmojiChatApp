...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[[self shared] hudCreate:nil image:nil spin:YES hide:NO interaction:NO];
	});
}
...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[[self shared] hudCreate:status image:nil spin:YES hide:NO interaction:NO];
	});
}
...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[[self shared] hudCreate:nil image:HUD_IMAGE_SUCCESS spin:NO hide:YES interaction:NO];
	});
}
...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[[self shared] hudCreate:status image:HUD_IMAGE_SUCCESS spin:NO hide:YES interaction:NO];
	});
}
...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[[self shared] hudCreate:nil image:HUD_IMAGE_ERROR spin:NO hide:YES interaction:NO];
	});
}
...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[[self shared] hudCreate:status image:HUD_IMAGE_ERROR spin:NO hide:YES interaction:NO];
	});
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (self.alpha == 1)
	{
		...
		[UIView animateWithDuration:0.5 delay:0 options:options animations:^{
			hud.transform = CGAffineTransformScale(hud.transform, 1.7, 1.7);
			hud.alpha = 0;
		}
